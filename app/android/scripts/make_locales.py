...
APP_STRINGS = {
    ...
    'getFastboot': {
        ...
        'vi': 'Lấy gói fastboot', 'th': 'รับแพ็กเกจ fastboot', 'ar': 'الحصول على حزمة fastboot',
    },
    'fastbootNotFound': {
        ...
        'ar': 'لا تحتوي واجهة Xiaomi على حزمة fastboot لهذا الفرع (ربما لم تُنشر بعد أو أُزيلت).',
    },
    'generic': {
